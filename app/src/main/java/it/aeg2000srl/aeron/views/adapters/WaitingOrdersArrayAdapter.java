 ...
 */
public class WaitingOrdersArrayAdapter extends ArrayAdapter<IOrder> {
    private final Activity context;
    private final List<IOrder> orders;
    int resourceId;

    public WaitingOrdersArrayAdapter(Activity context, int resource, List<IOrder> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(order != null) {
            ...
            if (customer != null) {
                ...
                holder.txtDescription.setText(customer.getName() + " [n. " + order.getId() + " del " + simpleDateFormat.format(order.getCreationDate()) + "]");
            } else {
